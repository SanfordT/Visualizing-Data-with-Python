...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            ...
            x='Vehicle Type',
            y='Number of Automobile Sales',
            title="Average Automobile Sales Based on Vehicle Type"))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            x='Vehicle Type',
            y='Total Advertising Expenditure',
            title='Total Expenditure Per Vehicle Type over Recession Period'))
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and selected_statistics=='value','Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        exp_data=yearly_data.groupby('Vehicle_Type')['Adversiting_Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
        x='Vehicle Type',
        y='Adversiting Expenditure',
